...
/*!*************************************!*\
  !*** ./resources/js/gsapScript1.js ***!
  \*************************************/
gsap.registerPlugin(ScrollTrigger);

var buttonAnim = function buttonAnim() {
  var tlMessageBtn = gsap.timeline({
    defaults: {
      duration: .1
    },
    repeat: -1,
...
gsap.from('.kategory-gsap-button-all', {
  scrollTrigger: '.kategory-gsap-capt',
  delay: .5,
  x: 100,
  opacity: 0,
